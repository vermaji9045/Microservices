...
import com.example.DtoClass.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in Public Bank",
        description = "CRUD REST APIs in Public Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
